...
/*    */   public void run() {
/*    */     try {
/* 44 */       Functions.printMessage(Util.EnumProductIDs.PEGASUS, LocaleMessage.getLocaleMessage("Task_for_verification_of_NEW_COMMANDS_started"), Enums.EnumMessagePriority.LOW, null, null);
/* 45 */       while (this.flag) {
/*    */         try {
...
/*    */             continue;
/*    */           } 
/* 51 */           List<Integer> moduleList = PegasusDBManager.executeSP_006();
/* 52 */           for (Integer idModule : moduleList) {
/* 53 */             synchronized (TblPegasusActiveConnections.getInstance()) {
/* 54 */               for (Map.Entry<String, InfoModule> connection : (Iterable<Map.Entry<String, InfoModule>>)TblPegasusActiveConnections.getInstance().entrySet()) {
...
/* 68 */       Functions.printMessage(Util.EnumProductIDs.PEGASUS, LocaleMessage.getLocaleMessage("Exception_in_the_task_for_verification_of_NEW_COMMANDS"), Enums.EnumMessagePriority.HIGH, null, ex);
...
/* 76 */     Functions.printMessage(Util.EnumProductIDs.PEGASUS, LocaleMessage.getLocaleMessage("Task_for_verification_of_NEW_COMMANDS_finalized"), Enums.EnumMessagePriority.LOW, null, null);
/*    */   }
/*    */ }


/* Location:              C:\Users\P042508\Desktop\jd-gui-windows-1.6.6\ZeusService.jar!\com\zeusServer\pegasus\ChkNewCommands.class
